        ...
        <span class="text-gray-700 dark:text-gray-300 text-right w-[90px]">
            ...
            <td class="px-5 py-4 text-center">
                ...
                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($statusClass); ?>">
                    <span class="w-1.5 h-1.5 rounded-full <?php echo e($status === 'COMPLETED' ? 'bg-emerald-500' : 'bg-amber-500'); ?>"></span>
                    <?php echo e($status); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/penjualan/index.blade.php ENDPATH**/ ?>