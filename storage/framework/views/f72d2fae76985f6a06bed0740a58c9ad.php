...
<div class="p-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <a href="<?php echo e(route('pembelian.create')); ?>"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $pembelians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pembelian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                            <td class="px-5 py-4 text-gray-500 dark:text-gray-400">
                                <?php echo e($pembelians->firstItem() + $index); ?>
                            ...
                            <td class="px-5 py-4 font-medium text-gray-900 dark:text-white">
                                <?php echo e($pembelian->pemasok->nama_distributor ?? '-'); ?>

                            </td>
                            <td class="px-5 py-4 text-gray-700 dark:text-gray-300 whitespace-nowrap">
                                Rp <?php echo e(number_format($pembelian->total, 0, ',', '.')); ?>

                            </td>
                            <td class="px-5 py-4 text-gray-600 dark:text-gray-300">
                                <?php echo e($pembelian->user->name ?? '-'); ?>

                            </td>
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('pembelian.show', $pembelian)); ?>"
                                    ...
                                    <form action="<?php echo e(route('pembelian.destroy', $pembelian)); ?>" method="POST"
        ...
        <?php if($pembelians->hasPages()): ?>
            <div class="px-5 py-4 border-t border-gray-200 dark:border-gray-700
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Menampilkan
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pembelians->firstItem()); ?></span>
                    hingga
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pembelians->lastItem()); ?></span>
                    dari
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pembelians->total()); ?></span>
                    hasil
                </p>
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/pembelian/index.blade.php ENDPATH**/ ?>