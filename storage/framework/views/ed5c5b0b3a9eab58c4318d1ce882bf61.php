...
<div class="p-6">
    ...
    <form action="<?php echo e(route('pembelian.store')); ?>" method="POST" id="form-pembelian">
        <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <select name="pemasok_id" required
                            ...
                            <?php $__currentLoopData = $pemasoks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pemasok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pemasok->id); ?>" <?php echo e(old('pemasok_id') == $pemasok->id ? 'selected' : ''); ?>>
        ...
        <td class="px-4 py-3">
            <select name="produk_id[]" required
                ...
                <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($produk->id); ?>"><?php echo e($produk->nama); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </td>
        <td class="px-4 py-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/pembelian/create.blade.php ENDPATH**/ ?>