<?php $__env->startSection('content'); ?>
    <div class="p-6">
        ...
        <form action="<?php echo e(url('/admin/users')); ?>" method="GET" class="mb-6">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                ...
                                <td class="px-5 py-4 text-gray-600 dark:text-gray-300"><?php echo e($user->email); ?></td>
                                ...
                                <td class="px-5 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <?php if(!$isAdmin): ?>
                                            ...
                                            <form action="<?php echo e(url('/admin/users/destroy/' . $user->id)); ?>" method="POST"
                                                onsubmit="return confirm('Yakin hapus <?php echo e($user->name); ?>?')">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/users/index.blade.php ENDPATH**/ ?>