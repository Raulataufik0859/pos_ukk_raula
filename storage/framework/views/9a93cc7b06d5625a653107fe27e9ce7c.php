<?php $__env->startSection('content'); ?>
    <div class="p-6">
        ...
        <form action="<?php echo e(route('laporan.penjualan')); ?>" method="GET" class="mb-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <?php $__empty_1 = true; $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                                ...
                                <td class="px-5 py-4 text-center">
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex px-2.5 py-1 rounded-full text-xs font-medium <?php echo e($metodeClass); ?>">
                                        <?php echo e($metode); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/laporan/penjualan.blade.php ENDPATH**/ ?>