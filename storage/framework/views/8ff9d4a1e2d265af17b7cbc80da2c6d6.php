...
<div class="p-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__empty_1 = true; $__currentLoopData = $pemasoks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pemasok): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/40 transition">
                            ...
                            <td class="px-5 py-4 font-medium text-gray-900 dark:text-white">
                                <?php echo e($pemasok->nama_distributor); ?>

                            </td>
                            <td class="px-5 py-4 text-gray-600 dark:text-gray-300">
                                <?php echo e($pemasok->no_telepon ?? '-'); ?>

                            </td>
                            <td class="px-5 py-4 text-gray-600 dark:text-gray-300">
                                <?php echo e($pemasok->email ?? '-'); ?>

                            </td>
                            <td class="px-5 py-4 text-gray-600 dark:text-gray-300">
                                <?php echo e($pemasok->alamat ?? '-'); ?>

                            </td>
                            <td class="px-5 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('pemasok.edit', $pemasok)); ?>"
                                    ...
                                    <form action="<?php echo e(route('pemasok.destroy', $pemasok)); ?>" method="POST"
        ...
        <?php if(method_exists($pemasoks, 'hasPages') && $pemasoks->hasPages()): ?>
            <div class="border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/40">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Menampilkan
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pemasoks->firstItem()); ?></span>
                    hingga
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pemasoks->lastItem()); ?></span>
                    dari
                    <span class="font-medium text-gray-900 dark:text-white"><?php echo e($pemasoks->total()); ?></span>
                    hasil
                </p>
                <div>
                <?php echo e($pemasoks->links()); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\pos_raul\resources\views/pemasok/index.blade.php ENDPATH**/ ?>