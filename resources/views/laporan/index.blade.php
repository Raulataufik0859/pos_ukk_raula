...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
            ...
            <p class="text-xs text-gray-400 mt-3">{{ $transaksiHariIni }} transaksi</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
            ...
            <p class="text-xs text-gray-400 mt-3">{{ now()->translatedFormat('F Y') }}</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $totalProduk }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ $stokRendah + $stokHabis }}</p>
                </div>
            ...
            <p class="text-xs text-gray-400 mt-3">
                <span class="text-amber-600">{{ $stokRendah }} rendah</span> ·
                <span class="text-rose-600">{{ $stokHabis }} habis</span>
            </p>
        </div>
    </div>
